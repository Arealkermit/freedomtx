...
RAW = Path(r".\trainer-status-build\tango2-ghst-firmware\firmware.bin")
OUT = Path(r".\trainer-status-build\tango2-ghst-usbtrainer-status-local.bin")
...
# ----------------------------------------------------------
# Sanity check application vector table
# ----------------------------------------------------------
...
# Tango 2 builds we've already verified use SRAM around 0x10010000.
if not (
...
# Reset handler should point into STM32 flash and be Thumb (odd address).
